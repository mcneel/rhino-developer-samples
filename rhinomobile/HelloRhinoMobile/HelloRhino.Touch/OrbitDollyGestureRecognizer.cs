...
// HelloRhino.Touch
//
// Created by dan (dan@mcneel.com) on 9/20/2013
...
namespace HelloRhino.Touch
{
	public class OrbitDollyGestureRecognizer : UIPanGestureRecognizer
	{
		...
		private PointF MidPointBetweenTouches (NSSet touches) 
		{
			...
			PointF location0 = touch0.LocationInView (this.View);
			PointF location1 = touch1.LocationInView (this.View);
