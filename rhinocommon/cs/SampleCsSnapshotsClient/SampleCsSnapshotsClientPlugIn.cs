namespace SampleCsSnapshotsClient
{
  ...
  ///</summary>
  public class SampleCsSnapshotsClientPlugIn : Rhino.PlugIns.PlugIn

  {
    public SampleCsSnapshotsClientPlugIn()
    {
      Instance = this;
    ...
    public static SampleCsSnapshotsClientPlugIn Instance
    {
      get; private set;
    }
