...
namespace MockingBirdRenderPlugIn
{
	public class MockingRealtimeDisplayMode : RealtimeDisplayMode
	{
			...
			RenderWindow renderWindow)
		{
			...
			reng = new MockingRender(Rhino.PlugIns.PlugIn.IdFromName("MockingBirdRenderPlugIn"), doc.RuntimeSerialNumber, view, renderWindow)
			{
				MaxPasses = 5000
			};
			...
			_theThread = new Thread(reng.ColorPixels) {Name = "MockingBirdRenderPlugIn thread"};
			_theThread.Start();
