...
RHINO_PLUG_IN_NAME( L"SampleRdkMaterialWithChildren" );

// Rhino plug-in id
// Provide a unique uuid for this plug-in
RHINO_PLUG_IN_ID( L"F2B5BB07-8E84-4812-A594-14C49B9B0A78" );
...
RHINO_PLUG_IN_DESCRIPTION(L"SampleRdkMaterialWithChildren plug-in for Rhinoceros®");
...
// The one and only CSampleRdkMaterialWithChildrenPlugIn object
static CSampleRdkMaterialWithChildrenPlugIn thePlugIn;

CSampleRdkMaterialWithChildrenPlugIn& SampleRdkMaterialAutoUIPlugIn()
{
  // Return a reference to the one and only CSampleRdkMaterialWithChildrenPlugIn object
  return thePlugIn;
}

CSampleRdkMaterialWithChildrenPlugIn::CSampleRdkMaterialWithChildrenPlugIn()
{
	// Description:
	//   CSampleRdkMaterialWithChildrenPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CSampleRdkMaterialWithChildrenPlugIn::OnLoadPlugIn() is called. The
...
{
	// Description:
	//   CSampleRdkMaterialWithChildrenPlugIn destructor. The destructor is called to destroy
	//   "thePlugIn" when the plug-in is unloaded. Immediately before the
	//   DLL is unloaded, CSampleRdkMaterialWithChildrenPlugIn::OnUnloadPlugin() is called. Do
...
const wchar_t* CSampleRdkMaterialWithChildrenPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CSampleRdkMaterialWithChildrenPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CSampleRdkMaterialWithChildrenPlugIn::PlugInID() const
{
	// Description:
...
BOOL CSampleRdkMaterialWithChildrenPlugIn::OnLoadPlugIn()
{
	// Description:
	...
	m_pRdkPlugIn = new CSampleRdkMaterialWithChildrenRdkPlugIn;
...
void CSampleRdkMaterialWithChildrenPlugIn::OnUnloadPlugIn()
{
	// Description:
...
CRhinoCommand::result CSampleRdkMaterialWithChildrenPlugIn::Render(const CRhinoCommandContext&, bool)
{
...
BOOL CSampleRdkMaterialWithChildrenPlugIn::AddToPlugInHelpMenu() const
{
	// Description:
...
BOOL CSampleRdkMaterialWithChildrenPlugIn::OnDisplayPlugInHelp( HWND hWnd ) const
{
	// Description:
