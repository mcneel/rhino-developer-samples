...
IMPLEMENT_DYNAMIC( CSpaceGizmoWnd, CWnd )

UINT CSpaceGizmoWnd::WM_SPACEGIZMO = ::RegisterWindowMessage( L"SpaceWareMessage00" );

CSpaceGizmoWnd::CSpaceGizmoWnd()
  : m_siHdl(0)
{
}
...
BEGIN_MESSAGE_MAP( CSpaceGizmoWnd, CWnd )
  ON_REGISTERED_MESSAGE( CSpaceGizmoWnd::WM_SPACEGIZMO, &CSpaceGizmoWnd::OnSpaceGizmo )
END_MESSAGE_MAP()

BOOL CSpaceGizmoWnd::InitializeSpaceGizmo()
{
...
LRESULT CSpaceGizmoWnd::OnSpaceGizmo( WPARAM wParam, LPARAM lParam )
{
  ...
  SiGetEventWinInit( &siEventData, CSpaceGizmoWnd::WM_SPACEGIZMO, wParam, lParam );
    ...
    case SI_MOTION_EVENT:
      {
        ...
        const CSpaceGizmoSettings& settings = SpaceGizmoPlugIn().SpaceGizmoSettings();
        ...
        static_cast<CSpaceGizmoView*>(view)->SetInDynamicViewChange( true );
        static_cast<CSpaceGizmoView*>(view)->UpdateTransforms();
        view->Redraw();
        break;
      }
      
    case SI_ZERO_EVENT:
      if( static_cast<CSpaceGizmoView*>(view)->InDynamicViewChange() )
      {
        static_cast<CSpaceGizmoView*>(view)->SetInDynamicViewChange( false );
        view->Redraw();
      }
      break;
