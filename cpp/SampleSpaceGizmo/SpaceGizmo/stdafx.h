...
{
#define OS_WIN32
#include "../SpaceBall/inc/spwmacro.h"   
#include "../SpaceBall/inc/si.h"
#include "../SpaceBall/inc/siapp.h"
#undef OS_WIN32
}
...
#if defined(NDEBUG)
#if defined(RHINO_DEBUG_PLUGIN)
#pragma comment(lib, "../SpaceBall/x64/PseudoDebug/SpaceBall.lib")
#else  // NDEBUG
#pragma comment(lib, "../SpaceBall/x64/Release/SpaceBall.lib")
#endif // RHINO_DEBUG_PLUGIN
#else  // DEBUG
#pragma comment(lib, "../SpaceBall/x64/Debug/SpaceBall.lib")
#endif // NDEBUG
#else  // WIN32
#if defined(NDEBUG) 
#if defined(RHINO_DEBUG_PLUGIN)
#pragma comment(lib, "../SpaceBall/Win32/PseudoDebug/SpaceBall.lib")
#else  // NDEBUG
#pragma comment(lib, "../SpaceBall/Win32/Release/SpaceBall.lib")
#endif // RHINO_DEBUG_PLUGIN
#else  // DEBUG
#pragma comment(lib, "../SpaceBall/Win32/Debug/SpaceBall.lib")
#endif // NDEBUG
#endif // WIN64
