/////////////////////////////////////////////////////////////////////////////
// SpaceGizmoSettings.cpp

#include "stdafx.h"
#include "SpaceGizmoSettings.h"

CSpaceGizmoSettings::CSpaceGizmoSettings()
{
  Defaults();
}

void CSpaceGizmoSettings::LoadProfile( LPCTSTR lpszSection, CRhinoProfileContext& pc )
{
  Defaults();
...
void CSpaceGizmoSettings::SaveProfile( LPCTSTR lpszSection, CRhinoProfileContext& pc )
{
...
void CSpaceGizmoSettings::Defaults()
{
