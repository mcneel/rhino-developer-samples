...
{
#define OS_WIN32
#include "../SampleSpaceBallLib/inc/si.h"
#include "../SampleSpaceBallLib/inc/siapp.h"
#undef OS_WIN32
}
...
#if defined(NDEBUG)
#if defined(RHINO_DEBUG_PLUGIN)
#pragma comment(lib, "../x64/Debug/SampleSpaceBallLib.lib")
#else
#pragma comment(lib, "../x64/Release/SampleSpaceBallLib.lib")
#endif
#else
#pragma comment(lib, "../x64/DebugRhino/SampleSpaceBallLib.lib")
#endif
