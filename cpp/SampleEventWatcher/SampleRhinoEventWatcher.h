/////////////////////////////////////////////////////////////////////////////
// SampleRhinoEventWatcher.h
//

#pragma once

/////////////////////////////////////////////////////////////////////////////
// CSampleRhinoEventWatcher
// See SampleRhinoEventWatcher.cpp for the implementation of this class
//
...
class CSampleRhinoEventWatcher : public CRhinoEventWatcher
{
  ...
  void FontTableEvent( CRhinoEventWatcher::font_event type, const CRhinoFontTable& font_table, int font_index, const ON_Font* old_settings );
