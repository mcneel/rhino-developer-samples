...
RHINO_PLUG_IN_ID(L"0F3BF7BF-F7E1-42EB-B6BA-67CD2BCC09E5");
...
RHINO_PLUG_IN_DESCRIPTION(L"Rhino SDK Sample - SampleCustomUndo");
...
{
  // Description:
  //   CSampleCustomUndoPlugIn constructor. The constructor is called when the
  //   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
  //   is loaded, CSampleCustomUndoPlugIn::OnLoadPlugIn() is called. The
...
{
  // Description:
  //   CSampleCustomUndoPlugIn destructor. The destructor is called to destroy
  //   "thePlugIn" when the plug-in is unloaded. Immediately before the
  //   DLL is unloaded, CSampleCustomUndoPlugIn::OnUnloadPlugin() is called. Do
...
GUID CSampleCustomUndoPlugIn::PlugInID() const
{
  ...
  // {0F3BF7BF-F7E1-42EB-B6BA-67CD2BCC09E5}
