/////////////////////////////////////////////////////////////////////////////
// SampleDocumentPropertiesPage.h
//
...
class CSampleDocumentPropertiesPage : public CRhinoOptionsDialogPage
{
	DECLARE_DYNAMIC(CSampleDocumentPropertiesPage)

public:
	CSampleDocumentPropertiesPage(CWnd* pParent = NULL);
	virtual ~CSampleDocumentPropertiesPage();
