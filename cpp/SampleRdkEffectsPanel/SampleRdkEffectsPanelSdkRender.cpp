...
CSampleRdkEffectsPanelSdkRender::CSampleRdkEffectsPanelSdkRender(const CRhinoCommandContext& context, CRhinoRenderPlugIn& plugIn,
...
CSampleRdkEffectsPanelSdkRender::~CSampleRdkEffectsPanelSdkRender()
{
...
bool CSampleRdkEffectsPanelSdkRender::RenderCore(void)
{
...
int CSampleRdkEffectsPanelSdkRender::ThreadedRender(void)
{
...
void CSampleRdkEffectsPanelSdkRender::SetContinueModal(bool b)
{
	m_bContinueModal = b;
}

void CSampleRdkEffectsPanelSdkRender::StopRendering()
{
	m_bCancel = true;
...
bool CSampleRdkEffectsPanelSdkRender::SetUpRender(CRhinoView* pView, bool bQuiet)
{
	if (nullptr == pView)
		return false;
...
CRhinoSdkRender::RenderReturnCodes CSampleRdkEffectsPanelSdkRender::Render(const ON_2iSize& sizeImage)
{
...
CRhinoSdkRender::RenderReturnCodes CSampleRdkEffectsPanelSdkRender::RenderWindow(CRhinoView* pView, const LPRECT pRect, bool bInPopupWindow)
{
...
BOOL CSampleRdkEffectsPanelSdkRender::NeedToProcessGeometryTable()
{
	return false;
}

BOOL CSampleRdkEffectsPanelSdkRender::NeedToProcessLightTable()
{
	return false;
}

BOOL CSampleRdkEffectsPanelSdkRender::RenderPreCreateWindow()
{
	return TRUE;
}

bool CSampleRdkEffectsPanelSdkRender::ReuseRenderWindow(void) const
{
...
{
	return reinterpret_cast<CSampleRdkEffectsPanelSdkRender*>(pv)->ThreadedRender();
}

void CSampleRdkEffectsPanelSdkRender::StartRendering()
{
...
BOOL CSampleRdkEffectsPanelSdkRender::StartRenderingInWindow(CRhinoView*, const LPCRECT rect)
{
	const auto* pDoc = CommandContext().Document();
	if (nullptr == pDoc)
		return false;
