/////////////////////////////////////////////////////////////////////////////
// cmdSampleAnalysisMode.cpp : command file
//
...
{ 0xD832A29C, 0x786C, 0x4AE3, { 0xA3, 0x3F, 0xB9, 0xBB, 0x6D, 0xA8, 0x9B, 0x3A } };
...
CRhinoCommand::result CCommandZAnalysisOff::RunCommand( const CRhinoCommandContext& context )
{
  ...
  {
    rhino_object->EnableAnalysisMode(
      theZAnalysisVAM.m_am_id,
      false
      );
  }
