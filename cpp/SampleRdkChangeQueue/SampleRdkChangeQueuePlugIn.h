// SampleRdkChangeQueuePlugIn.h : main header file for the SampleRdkChangeQueue plug-in.
//

#pragma once

// CSampleRdkChangeQueuePlugIn
// See SampleRdkChangeQueuePlugIn.cpp for the implementation of this class
//

class CSampleRdkChangeQueuePlugIn : public CRhinoUtilityPlugIn
{
public:
  ...
  // CSampleRdkChangeQueuePlugIn destructor. The destructor is called to destroy
  // "thePlugIn" when the plug-in is unloaded. Immediately before the
  // DLL is unloaded, CSampleRdkChangeQueuePlugIn::OnUnloadPlugin() is called. Do
  // not do too much here. Be sure to clean up any memory you have allocated
  // with onmalloc(), onrealloc(), oncalloc(), or onstrdup().
  ~CSampleRdkChangeQueuePlugIn() = default;
