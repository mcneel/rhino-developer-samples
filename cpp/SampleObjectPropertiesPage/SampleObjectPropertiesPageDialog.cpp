/////////////////////////////////////////////////////////////////////////////
// SampleObjectPropertiesPageDialog.cpp
//
...
: CRhinoObjectPropertiesDialogPageEx(nID, pParent)
, m_bVaries(false)
{
}
...
BEGIN_MESSAGE_MAP(CSampleObjectPropertiesPageDialog, CRhinoObjectPropertiesDialogPageEx)
...
CRhinoObjectPropertiesDialogPageEx::page_type CSampleObjectPropertiesPageDialog::PageType() const
{
  return CRhinoObjectPropertiesDialogPageEx::custom_page;
}

HICON CSampleObjectPropertiesPageDialog::Icon() const
{ 
  AFX_MANAGE_STATE( AfxGetStaticModuleState() );
  return (HICON)::LoadImage(AfxGetInstanceHandle(), MAKEINTRESOURCE(IDI_PAGE_ICON), IMAGE_ICON, 24, 24, LR_SHARED); 
}
...
BOOL CSampleObjectPropertiesPageDialog::OnInitDialog() 
{
  ...
  m_Resize.Add( IDC_E_HYPERLINK, CRhinoUiDialogItemResizer::resize_lockleft | CRhinoUiDialogItemResizer::resize_lockright );
	...
	CRhinoObjectPropertiesDialogPageEx::OnInitDialog();
...
{
  CRhinoObjectPropertiesDialogPageEx::PostNcDestroy();
