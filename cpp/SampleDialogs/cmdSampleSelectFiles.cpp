...
CRhinoCommand::result CCommandSampleSelectFiles::RunCommand( const CRhinoCommandContext& context )
{
  ...
  // Note, Visual Studio 2005's verison of CFileDialog does not have the "bVistaStyle" construction flag.
#if defined(WIN64)
  BOOL bVistaStyle = TRUE;
	CFileDialog dialog( TRUE, strDefExt, strDefFile, dwFlags, strFilter, pParentWnd, 0, bVistaStyle );
#else
	CFileDialog dialog( TRUE, strDefExt, strDefFile, dwFlags, strFilter, pParentWnd, 0 );
#endif
